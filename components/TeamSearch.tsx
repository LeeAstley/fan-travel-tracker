...
const UK_TEAMS: Team[] = [
  ...
  { id: 68,   name: "Nottingham Forest FC",        shortName: "Nott Forest",    tla: "NFO", crest: "https://crests.football-data.org/68.png",   competition: "Premier League" },
  ...
  { id: 328,  name: "Burnley FC",                  shortName: "Burnley",        tla: "BUR", crest: "https://crests.football-data.org/328.png",  competition: "Championship" },
  ...
  { id: 322,  name: "Middlesbrough FC",            shortName: "Middlesbrough",  tla: "MID", crest: "https://crests.football-data.org/322.png",  competition: "Championship" },
  ...
  { id: 71,   name: "Manchester City FC",          shortName: "Man City",       tla: "MCI", crest: "https://crests.football-data.org/65.png",   competition: "Premier League" },
  { id: 332,  name: "Sunderland AFC",              shortName: "Sunderland",     tla: "SUN", crest: "https://crests.football-data.org/332.png",  competition: "Championship" },
  { id: 345,  name: "Cardiff City FC",             shortName: "Cardiff",        tla: "CAR", crest: "https://crests.football-data.org/345.png",  competition: "Championship" },
  { id: 346,  name: "Swansea City AFC",            shortName: "Swansea",        tla: "SWA", crest: "https://crests.football-data.org/346.png",  competition: "Championship" },
  { id: 356,  name: "AFC Bournemouth",             shortName: "Bournemouth",    tla: "BOU", crest: "https://crests.football-data.org/356.png",  competition: "Premier League" },
  { id: 371,  name: "Sheffield United FC",         shortName: "Sheffield Utd",  tla: "SHU", crest: "https://crests.football-data.org/371.png",  competition: "Championship" },
  { id: 373,  name: "Blackburn Rovers FC",         shortName: "Blackburn",      tla: "BLB", crest: "https://crests.football-data.org/373.png",  competition: "Championship" },
  { id: 374,  name: "Watford FC",                  shortName: "Watford",        tla: "WAT", crest: "https://crests.football-data.org/374.png",  competition: "Championship" },
  { id: 375,  name: "Norwich City FC",             shortName: "Norwich",        tla: "NOR", crest: "https://crests.football-data.org/375.png",  competition: "Championship" },
  { id: 383,  name: "Luton Town FC",               shortName: "Luton",          tla: "LUT", crest: "https://crests.football-data.org/383.png",  competition: "Championship" },
  { id: 384,  name: "Preston North End FC",        shortName: "Preston",        tla: "PRE", crest: "https://crests.football-data.org/384.png",  competition: "Championship" },
  { id: 385,  name: "Queens Park Rangers FC",      shortName: "QPR",            tla: "QPR", crest: "https://crests.football-data.org/385.png",  competition: "Championship" },
  { id: 386,  name: "Bristol City FC",             shortName: "Bristol City",   tla: "BRC", crest: "https://crests.football-data.org/386.png",  competition: "Championship" },
  { id: 389,  name: "Hull City AFC",               shortName: "Hull",           tla: "HUL", crest: "https://crests.football-data.org/389.png",  competition: "Championship" },
  { id: 394,  name: "Millwall FC",                 shortName: "Millwall",       tla: "MIL", crest: "https://crests.football-data.org/394.png",  competition: "Championship" },
  ...
  { id: 715,  name: "Portsmouth FC",               shortName: "Portsmouth",     tla: "POR", crest: "https://crests.football-data.org/715.png",  competition: "Championship" },
